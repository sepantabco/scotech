...
export default class GameCenterView extends React.Component {
    ...
    attend() {
        fetch('https://parsbeacon.ir/requests/add_to_event?username=' + this.state.username + '&event_id=' + this.state.events[this.state.event_index].id,{headers: {Authorization: get_key()}}, this).then(
                ...
                <ScrollView>
                    <Modal
                        ...
                        <EventModal title={this.state.events[this.state.event_index].title}
                                    ...
                                    mode={this.state.events[this.state.event_index].time_mode}
                                    time={parseInt(this.state.events[this.state.event_index].end_time)}/>
                        }
                    ...
                    <TouchableOpacity
                        onPress={() => this.props.navigation.navigate('webview', {url: 'https://beacongameserver.ir/index.html?username=' + this.state.username})}>
