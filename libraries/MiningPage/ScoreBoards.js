        ...
        return (
            <SafeAreaView style={{ flex: 1 }}>
                <View style={{ height: 50, flexDirection: 'row-reverse', backgroundColor: 'yellow' }}>
                    <TouchableOpacity style={{ flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: '#9720d2', height: (this.state.tabSelected === 'total') ? '92%' : '100%' }} onPress={() => this._pageSelected('total')}>
                        <Text style={{ fontFamily: 'IRANsansMobile', fontSize: 16, color: 'white' }}>کل</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={{ flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: '#9720d2', height: (this.state.tabSelected === 'eachgame') ? '92%' : '100%' }} onPress={() => this._pageSelected('eachgame')}>
                        <Text style={{ fontFamily: 'IRANsansMobile', fontSize: 16, color: 'white' }}>هر بازی</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={{ flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: '#9720d2', height: (this.state.tabSelected === 'storyboardleages') ? '92%' : '100%' }} onPress={() => this._pageSelected('storyboardleages')}>
