...
export default class ADinfo extends Component {
    ...
    _changeText(id) {
        switch (id) {
            case 1:
                this.setState({
                    color_text_1: '#5856D6', color_text_2: '#5AC8FA',
                    color_text_3: '#5AC8FA'
                });
                break;
            case 2:
                this.setState({
                    color_text_1: '#5AC8FA', color_text_2: '#5856D6',
                    color_text_3: '#5AC8FA'
                });
                break;
            case 3:
                this.setState({
                    color_text_1: '#5AC8FA', color_text_2: '#5AC8FA',
                    color_text_3: '#5856D6'
                });
                break;
        }
                ...
                <ScrollView style={{flex: 1}}>
                    ...
                    <View style={{flex: 3, justifyContent: 'space-between', flexDirection: 'row'}}>
                        <View style={{flex: 4, flexDirection: 'column', padding: 20}}>
                                ...
                                <View style={{flexDirection: 'row'}}>
                                    ...
                                    {this.state.data.Scoin_available == 1 && <Text style={{
                                        ...
                                        fontFamily: 'IRANSansMobile'
                                               ...
                                               style={{width: 15, height: 15}}/> کوین</Text>}
                                    <Text
                                        style={{color: 'black', fontSize: 15}}>{this.state.data.cost.toString()}</Text>
                                    <Text style={{
                                        color: '#707070',
                                        fontStyle: 'italic',
                            ...
                            <TouchableOpacity onPress={() => {
                                ...
                                <LinearGradient colors={['#0078ff', '#00edff']} start={{x: 0, y: 1}} end={{x: 1, y: 1}}
                                                style={{
                                                    overflow: 'hidden',
                                                    borderRadius: 10,
                                                    marginTop: 10,
                    ...
                    <View style={{flexDirection: 'row', marginTop: 5, justifyContent: 'space-between'}}>
                        <Text style={{
                            ...
                            marginLeft: 10,
                            marginTop: 5
                        }}>+{this.state.data.bought.toString()} </Text>
                        ...
                        <View
                            ...
                            <Text style={{marginTop: 8, fontFamily: 'IRANSansMobile'}}>{this.state.data.timers.toString()} روز باقی مانده </Text>
                            }
                                        ...
                                        <View style={{
                                            ...
                                            <View style={{flexDirection: 'row'}}>
                                                ...
                                                <Text style={{
                                                    textAlign: 'left',
                                                    fontSize: 15
                                                }}>سطح{item.min_level.toString()}</Text>
                                            </View>
                                            <View>
                                                <Text style={{
                                                    fontSize: 14,
                                            ...
                                            <ImageBackground key={item.id}
                                                ...
                                                <View style={{marginLeft: 10, height: 25, backgroundColor: 'black'}}>
                                                    <Text style={{
                                                        color: 'white',
                                                        fontSize: 20
                                                    }}>{item.off.toString()}%</Text>
                                                </View>
                                            </ImageBackground>
                                        </TouchableOpacity>
                                        <View
                                            style={{justifyContent: 'center', flexDirection: 'row', marginBottom: 10}}>
                                            <Image key={item.id}
                                                   source={require('../images/logos/Timer.png')}
                                                   style={{width: 35, height: 35, marginRight: 30, borderRadius: 40}}/>
