        ...
        return (
            <SafeAreaView style={{ flex: 1 }}>
                ...
                <ScrollView>
                    ...
                    <View style={{ width: '95%', height: 70, alignSelf: 'center', marginTop: 10, flexDirection: 'row-reverse' }}>
