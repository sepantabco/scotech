            ...
            <View style={{ flex: 1, backgroundColor: '#f5f5f5', marginTop: 25 }}>
                <View style={{ flex: 7, }}>
                    {this.state.smsSent == false ?
                        (
                            <ScrollView>
                                <View style={{ flex: 1, width: '75%', flexDirection: 'row', height: '15%', backgroundColor: 'white', marginVertical: 10, alignSelf: 'center', elevation: 1, borderColor: '#f5f5f5', borderWidth: 1, borderRadius: 20, justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: '5%' }}>
                                    <TextInput placeholder='شماره تلفن را وارد کنید' numberOfLines={1} style={{ width: '85%', fontFamily: 'IRANSans(FaNum)', fontSize: 10 }} />
